...
from core.data_handler import load_fs, AppData
...
def instantiate_filesystem():
    return load_fs(client_kwargs=client_kwargs, key=st.secrets['AWS_ACCESS_KEY_ID'], secret=st.secrets['AWS_SECRET_ACCESS_KEY']) 
